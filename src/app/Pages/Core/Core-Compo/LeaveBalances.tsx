    ...
    <section className="py-2">
      <header className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="font-gilSemiBold text-2xl text-gray-900">
              Leave Summary
            </h1>
          ...
          <div className="flex items-center space-x-2 px-4 py-2 bg-sky-50 rounded-lg border border-sky-100">
            <User className="w-4 h-4 text-sky-600" />
            <span className="font-gilMedium text-sky-700">
              {assignMembers.length} Team Members
            </span>
          </div>
        </div>
      </header>
      ...
      <main className="">
        {assignMembers && assignMembers.length === 0 ? (
          ...
          <div className="space-y-4">
            {assignMembers.map((member, index) => {
